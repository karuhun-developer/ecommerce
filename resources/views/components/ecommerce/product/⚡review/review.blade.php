            ...
            <div class="border-b pb-6">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-1">
                        ...
                        <flux:icon.star class="w-4 h-4 text-yellow-400 fill-yellow-400"/>
                        <flux:icon.star class="w-4 h-4 text-yellow-400 fill-yellow-400"/>
                        <span class="text-gray-400 text-xs ml-2 font-medium">1 hari yang lalu</span>
                    </div>
                    <button class="text-gray-400 hover:text-gray-600"><flux:icon.ellipsis-horizontal class="w-5 h-5"/></button>
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-8 h-8 rounded-full bg-gray-200 overflow-hidden">
                        <img src="https://ui-avatars.com/api/?name=Budi+Santoso&background=random" alt="Avatar" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <span class="font-bold text-gray-900 text-sm block">Budi Santoso</span>
                    </div>
                </div>
                <p class="text-sm text-gray-700 mb-4 leading-relaxed">Barang original, packing aman pakai bubble wrap tebal. Pengiriman juga cepat. Recommended seller! Mouse nya ringan banget enak buat main Valorant.</p>
                <div class="flex gap-2 mb-4">
                    <div class="w-16 h-16 rounded-lg border overflow-hidden cursor-pointer hover:opacity-80 transition">
                        <img src="https://images.unsplash.com/photo-1527443154391-42075928d114?auto=format&fit=crop&q=80&w=150&h=150" class="w-full h-full object-cover">
                    </div>
                </div>
            ...
            <div class="border-b pb-6">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-1">
                        ...
                        <flux:icon.star class="w-4 h-4 text-yellow-400 fill-yellow-400"/>
                        <flux:icon.star class="w-4 h-4 text-yellow-400 fill-yellow-400"/>
                        <span class="text-gray-400 text-xs ml-2 font-medium">3 hari yang lalu</span>
                    </div>
                    <button class="text-gray-400 hover:text-gray-600"><flux:icon.ellipsis-horizontal class="w-5 h-5"/></button>
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-8 h-8 rounded-full bg-gray-200 overflow-hidden">
                        <img src="https://ui-avatars.com/api/?name=Andi+Wijaya&background=random" alt="Avatar" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <span class="font-bold text-gray-900 text-sm block">Andi Wijaya</span>
                    </div>
                </div>
