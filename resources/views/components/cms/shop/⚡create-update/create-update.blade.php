        ...
        <form class="space-y-6" wire:submit.prevent="submit">
            <div>
                ...
                <flux:text class="mt-2">
                    {{ $isUpdate ? 'Update the details of the shop below.' : 'Fill in the details to create a new shop.' }}
                </flux:text>
            </div>
                                    ...
                                    @foreach($areas as $area)
                                        <li>
                                            ...
                                            >
                                                ...
                                                <div class="text-xs text-gray-500">Postal: {{ $area['postal_code'] }} | {{ $area['administrative_division_level_1_name'] }}</div>
                                            </button>
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        initMap() {
                            this.loadLeaflet().then(() => {
                                if (!this.map) {
                                    ...
                                    let newPos = [this.lat || -6.200000, this.lng || 106.816666];
                                    this.marker.setLatLng(newPos);
                                    this.map.panTo(newPos);
                                }
